...
def main():
    ...
    cmapR = matplotlib.cm.get_cmap('Purples')
    cmapB = matplotlib.cm.get_cmap('Greens')
    cmapY = matplotlib.cm.get_cmap('Blues')
    cmapG = matplotlib.cm.get_cmap('Reds')
    ...
    figure.savefig(f"../figs/lisboa04.pdf", dpi=1000)
