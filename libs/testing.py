...
def compute_predictions_lowV(root_folder, model_name, dataset_test, n_samp, nx, ny, res, us, channels, noise, generator, discriminator, generator_optimizer, discriminator_optimizer, subversion, save_mat=False):
    """
        Training logic for GAN architectures.
    ...
    cbc_predic = np.zeros((n_samp, ny*us, nx*us, channels), np.float32)
    gap_predic = np.zeros((n_samp, ny*us, nx*us, channels), np.float32)
    fl_target = np.zeros((n_samp, ny*us, nx*us, 2), np.float32)
...
def compute_predictions_onlyU(root_folder, model_name, dataset_test, n_samp, nx, ny, res, us, channels, noise, generator, discriminator, generator_optimizer, discriminator_optimizer, subversion, save_mat=False):
    """
        Training logic for GAN architectures.
